...
test_study = "/home/single3/Documents/tintrung/brainmri/trungdc/1.2.840.113619.6.408.217046082646534226129609417598798276891/DICOM"
for file_name in os.listdir(test_study):
    file_path = os.path.join(test_study, file_name)
...
print(df_dcm)
df_dcm.to_pickle('/home/single3/Documents/tintrung/brainmri/trungdc/1.2.840.113619.6.408.217046082646534226129609417598798276891/test_dicom.pkl')
# %%
