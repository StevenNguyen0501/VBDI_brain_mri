...
def plotResult(pklfilepath, output_image_name, heading):
    save_im_path = "/home/single2/tintrung/VBDI_brain_mri/yolov5/train_shuffle/saved_im"
    ...
    # plt.show()
    plt.tight_layout()
    fig.suptitle(heading, fontsize = 24)
    fig.savefig(os.path.join(save_im_path,output_image_name + ".png"))
    plt.close()
# %%
plotResult("/home/single2/tintrung/VBDI_brain_mri/yolov5/train_shuffle/saved_result/kfold_combine_three.pkl", "CombineThree", "CombineThreeSequence")
# %%
