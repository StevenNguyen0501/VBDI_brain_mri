...
if __name__ == '__main__':
            ...
            if num_train_mass_imgs >= 6*num_val_mass_imgs:
                if num_train_edema_imgs >= 6*num_val_edema_imgs: 
                    ...
                    if not opt.evolve:
                        ...
                        _, map_05 = train(hyp, opt, device, tb_writer)
                        LIST_SAVED_MAP.append(map_05)
                    # Evolve hyperparameters (optional)
                        ...
                        for _ in range(300):  # generations to evolve
                            ...
                            # Train mutation
                            results, map_05 = train(hyp.copy(), opt, device)
                            LIST_SAVED_MAP.append(map_05)
    ...
    print(f'================ BEST RESULTS IN SAMPLE {np.argmax(LIST_SAVED_MAP)} WITH mAP@.5 = {LIST_SAVED_MAP[np.argmax(LIST_SAVED_MAP)]}================')
